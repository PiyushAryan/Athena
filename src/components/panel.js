  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="font-Montserrat text-5xl text-teal-700 ml-10 mb-12 font-black text-left">
        ...
        <p className="border ml-10 mb-2 max-w-[40vw] border-transparent text-sm bg-black font-Inter text-opacity-80 text-gray-100 font-face">Store, share and access all your files in one platform</p>
